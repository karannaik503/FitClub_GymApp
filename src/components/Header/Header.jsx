...
const Header = () => {
  ...
  return (
    <div className='header'>
        ...
        {(menuOpened===false && mobile===true)? (<div style={{background: 'var(--appColor)', padding: '0.5rem', borderRadius: '5px'}} onClick={()=> setMenuOpened(true)} ><img src={Bars} alt="logo" className='' style={{width: "1.5rem", height: '1.5rem'}} /></div>): 
        (<ul className='header-menu'>
          <li><Link onClick={()=>setMenuOpened(false)} to="header" span={true} activeClass='active' smooth={true}>Home</Link></li>
